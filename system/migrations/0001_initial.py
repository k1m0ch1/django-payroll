# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-17 11:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('karyawan', models.ManyToManyField(related_name='karyawan', to='system.Karyawan')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='shift',
            field=models.ManyToManyField(related_name='shift', to='system.Shift'),
        ),
        migrations.AddField(
            model_name='karyawan',
            name='perusahaan',
