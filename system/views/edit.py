...
def potongan_save(request, potongan_id):
	...
	d.update(koperasi=request.POST['koperasi'], pinjkaryawan=request.POST['pinjaman'], 
			 cicil_pinjkaryawan = request.POST['cicil'], cicil_koperasi = request.POST['cicil_koperasi'])
