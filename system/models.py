...
class GajiPokok(models.Model):
	...
	tmakan = models.DecimalField(max_digits=7, decimal_places=0)
	transportexec = models.DecimalField(max_digits=7, decimal_places=0)
	transportnonexec = models.DecimalField(max_digits=7, decimal_places=0)
	jabatan = models.DecimalField(max_digits=7, decimal_places=0)
	shift = models.DecimalField(max_digits=7, decimal_places=0)
