...
class GajiPokok(models.Model):
	...
	desc = models.TextField(null=True)
	gajipokok = models.DecimalField(max_digits=20, decimal_places=0, default=0)
	jabatan = models.DecimalField(max_digits=9, decimal_places=0, null=True, default=0)
	shift = models.DecimalField(max_digits=9, decimal_places=0, null=True, default=0)
	makanlembur = models.DecimalField(max_digits=9, decimal_places=0, null=True, default=0)
	translembur = models.DecimalField(max_digits=9, decimal_places=0, null=True, default=0)
...
class Bonusthr(models.Model):
	...
	toggle = models.DecimalField(max_digits=1, decimal_places=0, null=True, default=0)
	created_at = models.DateTimeField(auto_now=True)
	updated_at = models.DateTimeField(auto_now_add=True, null=True)
...
class PotonganKaryawan(models.Model):
	...
	cicil_koperasi = models.DecimalField(max_digits=2, decimal_places=0, null=True, default=0)
	sisa_cicil_koperasi = models.DecimalField(max_digits=2, decimal_places=0, null=True, default=0)
	...
	sisa_cicil_pinjkaryawan = models.DecimalField(max_digits=2, decimal_places=0,null=True, default=0)
