...
class Karyawan(models.Model):
	...
	telepon = models.DecimalField(max_digits=12)
	handphone = models.DecimalField(max_digits=18)
	ktpid = models.DecimalField(max_digits=30)
	...
	jumlahhari = models.DecimalField(max_digits=1)
...
class GajiPokok(models.Model):
	...
	name = models.CharField(max_length=25)
	desc = models.TextField()
	gajipokok = models.DecimalField(max_digits=10)
	tunjanganmakan = models.DecimalField(max_digits=7)
	tunjangantransport = models.DecimalField(max_digits=7)
	tunjanganjabatan = models.DecimalField(max_digits=7)
	create_date = models.DateTimeField(auto_now=True)
	update_date = models.DateTimeField(auto_now_add=True, blank=True)
